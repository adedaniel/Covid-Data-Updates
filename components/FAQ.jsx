...
export default function FAQS() {
  ...
  const askQuestion = (e) => {
    ...
    Axios.post(URL + "/ask", payload)
      .then((result) => {
        setIsLoading(false);
        setStoredQuestion(result.data.data[0].question);
        setIsFetched(true);
        setAnswers(result.data.data[0].answers);
      })
      .catch((error) => {
        setIsLoading(false);
        setHasError(true);
    ...
    <>
      <div className="bgImage d-table">
        <div className="container text-center captionArea">
          ...
          <form action="submit" onSubmit={askQuestion}>
            ...
            <button className="search" disabled={isLoading} type="submit">
              {isLoading ? (
                ...
                <i
                  className="fa fa-search icon colorPrimary"
                  aria-hidden="true"
                ></i>
              )}
            </button>
          ...
          <small className="text-white d-inline-block">
            Ask questions related to coronavirus{" "}
          </small>
        </div>
      </div>
      ...
      <div className="container pt-3">
        {isLoading === false && isFetched && answers.length !== 0 ? (
          <>
            <h4 className="my-4">
              Showing most relevant answers for '{storedQuestion}'{" "}
            </h4>
            {answers.slice(0, 5).map((eachAnswer, index) => (
              <FadeIn key={index}>
                <div className="bg-white newsCard py-3 px-4 my-3">
                  ...
                  <small className="m-0 textGrey">
                    Sourced from {eachAnswer.meta.source}{" "}
                    {eachAnswer.meta.country} | {eachAnswer.meta.last_update}
                  </small>
                  <h5>
                    ...
                    <a
                      ...
                      href={eachAnswer.meta.link}
                      className="text-dark text-decoration-none"
                    >
                      <span className="newsLink text-decoration-none">
                        Read More
                      </span>
                    </a>
                  </h5>
        ...
        {isLoading === false && isFetched && answers.length === 0 ? (
          <>
            ...
            <h4 className="text-center">
              No search results found. Try to be more specific with your words
              and check for typing errors
            </h4>
          </>
        ) : (
          ""
        ...
        <div className="accordion my-5" id="accordionExample">
          ...
          <div className="card">
            ...
            >
              <div className="card-body">
                ...
                this route is not a main feature of the outbreak. WHO is
                assessing ongoing research on the ways COVID-19 is spread and
                will continue to share new findings. Because this is a risk,
                however, it is another reason to clean hands regularly, after
          ...
          <div className="card">
            ...
            >
              <div className="card-body">
                ...
                However, masks might be worn in some countries according to
                local cultural habits. If masks are used, best practices should
                be followed on how to wear, remove, and dispose of them and on
                hand hygiene action after removal. For more information, visit
                the WHO guidance on use of masks in the community.
              </div>
            </div>
          </div>
          <div className="card">
            ...
            >
              <div className="card-body">
                ...
                whether there is a COVID-19 outbreak unfolding there. For most
                people in most locations the risk of catching COVID-19 is still
                low. However, there are now places around the world (cities or
                areas) where the disease is spreading. For people living in, or
                visiting, these areas the risk of catching COVID-19 is higher.
                Governments and health authorities are taking vigorous action
                every time a new case of COVID-19 is identified. Be sure to
                comply with any local restrictions on travel, movement or large
                gatherings. Cooperating with disease control efforts will reduce
                your risk of catching or spreading COVID-19. COVID-19 outbreaks
                can be contained and transmission stopped, as has been shown in
                China and some other countries. Unfortunately, new outbreaks can
                emerge rapidly. It’s important to be aware of the situation
                where you are or intend to go. WHO publishes daily updates on
                the COVID-19 situation worldwide. You can see these at
                <br />
          ...
          <div className="card">
            <div className="card-header" id="headingEleven">
              ...
              >
                Should I wear a mask to protect myself from catching the
                COVID-19 virus?
              </h3>
            </div>
            <div
            ...
            >
              <div className="card-body">
                Should I wear a mask to protect myself from catching the
                COVID-19 virus? Only wear a mask if you are ill with COVID-19
                symptoms (especially coughing) or looking after someone who may
                have COVID-19. Disposable face mask can only be used once. If
                you are not ill or looking after someone who is ill then you are
                wasting a mask. There is a world-wide shortage of masks, so WHO
                urges people to use masks wisely. WHO advises rational use of
                medical masks to avoid unnecessary wastage of precious resources
                and mis-use of masks . The most effective ways to protect
                yourself and others against COVID-19 are to frequently clean
                your hands, cover your cough with the bend of elbow or tissue
                and maintain a distance of at least 1 meter (3 feet) from people
          ...
          <div className="card">
            ...
            >
              <div className="card-body">
                ...
                because the immune response to COVID-19 is not yet understood,
                it is not yet known whether similar immune protection will be
          ...
          <div className="card">
            ...
            >
              <div className="card-body">
                ...
                has any connection with COVID-19. At this time, it is not clear
                or known if the spread of COVID-19 will decrease when the
          ...
          <div className="card">
            ...
            >
              <div className="card-body">
                ...
                COVID-19; NCDC National Reference Laboratory; Virology
                Laboratory of Lagos University Teaching Hospital; Irrua
                Specialist Teaching Hospital; Nigerian Institute of Medical
                Research; and African Centre of Excellence for Genomics of
                Infectious Diseases. They are all in the NCDC molecular
                laboratory network. Health officials are advised to call
                07032864444 for sample transportation and related advice if they
                have a case that fits the national case definition.
              </div>
            </div>
          </div>
        </div>
